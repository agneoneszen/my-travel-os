      ...
      <div className="p-4 space-y-6 pb-20">
        ...
        <div className="bg-hero-sand-50 p-6 rounded-[2rem] shadow-sm border border-slate-100">
            ...
            <div className="flex gap-3">
                ...
                <button onClick={handleImportClick} className="flex-1 bg-hero-sand-50 border-2 border-slate-200 text-slate-600 py-3 rounded-xl font-bold text-sm hover:border-slate-800 hover:text-hero-dark transition-colors flex items-center justify-center gap-2">
